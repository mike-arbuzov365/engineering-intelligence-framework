...
| Optional integration contract | **Partial** | Config schema, provider reachability, allowed data-boundary, failure-policy validation, and degraded-mode docs exist. Real Graphify freshness/query and RTK version/argv/health/telemetry adapters are not ported or tested yet; see [`integrations/README.md`](integrations/README.md) |
