...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        bytecode_dir = fake_fw / eif_init.BUNDLE_TREES[0] / "__pycache__"
        bytecode_dir.mkdir()
        (bytecode_dir / "fixture.cpython-311.pyc").write_bytes(b"generated")
        (fake_fw / eif_init.BUNDLE_TREES[0] / "fixture.pyo").write_bytes(b"generated")
        ...
        source_paths = [rel for _source, rel in sources]
        results.append(check(
            "collect_bundle_sources excludes interpreter-generated bytecode",
            not any("__pycache__" in rel or rel.endswith((".pyc", ".pyo")) for rel in source_paths),
            str(source_paths),
        ))
