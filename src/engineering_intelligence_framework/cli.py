...
scripts/sync_package_sources.py). No business logic lives in this file or
in commands/ - only argv assembly and dispatch.
...
from .commands import doctor, init_cmd, privacy_scan, render, search, validate, version
